...
export default StyleSheet.create({
    ...
    openRecipeModuleButton:{padding:12, backgroundColor: "#E0E0E0", alignItems:"center"},
    addRecipeButtonDisabled:{padding:12, backgroundColor: "#E0E0E0", alignItems:"center"}, 
    addRecipeButtonEnabled:{padding:12, backgroundColor: "#2289ffff", alignItems:"center"}, 
